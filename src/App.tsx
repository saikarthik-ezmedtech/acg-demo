    ...
    return (
      <div className="appointment-modal" role="presentation" onClick={onClose}>
        ...
        >
          ...
          <div style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '64px', height: '64px', borderRadius: '50%', backgroundColor: 'rgba(34, 195, 181, 0.12)', color: '#22C3B5', marginBottom: '20px', fontSize: '32px' }}>
            ✓
          </div>
          <h3 id="appointment-modal-title" style={{ color: '#16306F', fontFamily: 'var(--font-heading)', fontSize: '26px', margin: '0 0 12px 0' }}>
            Request Received
          </h3>
          <p style={{ color: 'rgba(22, 48, 111, 0.78)', fontSize: '15px', lineHeight: '1.5', maxWidth: '400px', margin: '0 auto 24px auto' }}>
            Thank you, <strong>{formData.firstName}</strong>. We have received your request and will follow up with you at <strong>{formData.email}</strong> or <strong>{formData.phone}</strong> to confirm your appointment.
          </p>
          ...
          <div className="appointment-form__row">
            <label>
              ...
              {touched.firstName && errors.firstName && (
                <span className="appointment-form-error">{errors.firstName}</span>
              )}
            </label>
            <label>
              Last name
              ...
              {touched.lastName && errors.lastName && (
                <span className="appointment-form-error">{errors.lastName}</span>
              )}
            </label>
          </div>
          <label>
            ...
            {touched.phone && errors.phone && (
              <span className="appointment-form-error">{errors.phone}</span>
            )}
          </label>
          <label>
            Email
            ...
            {touched.email && errors.email && (
              <span className="appointment-form-error">{errors.email}</span>
            )}
          </label>
          <label>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span>Reason for visit</span>
              <span style={{ fontSize: '11px', fontWeight: 500, color: formData.reason.length > 480 ? '#D9232E' : 'rgba(22, 48, 111, 0.6)' }}>
            ...
            {touched.reason && errors.reason && (
              <span className="appointment-form-error">{errors.reason}</span>
            )}
          </label>
